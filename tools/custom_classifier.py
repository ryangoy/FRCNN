...
def parse_args():
    ...
    parser.add_argument('--path', dest='folder_path', help = 'Path to input dataset')
...
if __name__ == '__main__':
    ...
    caffemodel = '/home/ryan/vision/py-faster-rcnn/output/faster_rcnn_end2end/imagenet_train/vgg16_faster_rcnn_iter_3000.caffemodel'
    ...
    im_names = []
#    folder_path = '/home/ryan/vision/UIC_dataset'
    ...
    #for im_name in im_names:
        ...
        #count+=1
        print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
	print 'Classification for {}'.format(im_names[i])
        demo(net, im_names[i])
