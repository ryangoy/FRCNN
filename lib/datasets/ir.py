...
class ir(imdb):
    ...
    def _get_ir_results_file_template(self):
        # INdevkit/results/IN2016/Main/<comp_id>_det_test_aeroplane.txt
    ...
    def _write_ir_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} Imagenet results file'.format(cls)
            filename = self._get_ir_results_file_template().format(cls)
    ...
    def _do_matlab_eval(self, output_dir='output'):
        ...
        cmd += 'imagenet_eval(\'{:s}\',\'{:s}\',\'{:s}\',\'{:s}\'); quit;"' \
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_ir_results_file(all_boxes)
